...
const CongratulationsPage = () => {
    ...
    useEffect(() => {
      ...
      return mainButton.onClick(() => {navigate('/nft')});
  }, []);
      ...
      <Page back={false}>
        <div className="bg-transparent p-8 text-white text-center w-[100vw] min-h-screen flex items-center">
          ...
          <div className="absolute top-[50%] left-[50%]">
            {isConfetti && <ConfettiExplosion force={0.90} width={1000} colors={['#45EBA5', '#21ABA5', '#163A5F', '#1D566E']} particleSize={6} particleCount={250} onComplete={() => {setIsConfetti(false)}}/>}
          </div>
